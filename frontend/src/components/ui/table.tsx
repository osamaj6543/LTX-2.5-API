...
function Table({ className, ...props }: React.ComponentProps<"table">) {
  return (
    <div data-slot="table-container" className="relative w-full overflow-x-auto scrollbar-slim">
...
export { Table, TableHeader, TableBody, TableCaption, TableHead, TableRow, TableFooter, TableCell };
